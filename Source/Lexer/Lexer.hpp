...
private:
    ...
    std::map<std::string, TokenType> keywords = {
        ...
        {"string", TokenType::stringType}, {"void", TokenType::voidType}, {"true", TokenType::boolLiteral}, {"false", TokenType::boolLiteral}, {"func", TokenType::funcKey}, {"class", TokenType::classKey}, {"nil", TokenType::nilLiteral}, {"while", TokenType::whileKey}, {"return", TokenType::returnKey}
    };
